    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Person` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `nome` TEXT NOT NULL, `idade` INTEGER NOT NULL)');
  ...
  Stream<List<Person>> findAllPersons() {
    return _queryAdapter.queryListStream('SELECT * FROM Person',
        mapper: (Map<String, Object?> row) =>
            Person(row['nome'] as String, row['idade'] as int),
